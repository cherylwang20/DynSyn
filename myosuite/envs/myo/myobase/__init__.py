...
register_env_with_variants(id='myoStandingBack-v0',
        ...
        kwargs={
            ...
            'target_jnt_range': {'LB_wrapjnt_t1':(0, 0),'LB_wrapjnt_t2':(0, 0),'LB_wrapjnt_r3':(0, 0),
                                 ...
                                 'flex_extension':(-0.3, -0.3),'lat_bending':(-0.436, 0.436),'axial_rotation':(0, 0),
...
register_env_with_variants(id='myoStandingBack-v1',
        ...
        kwargs={
            'model_path': curr_dir+'/../../../simhive/myo_sim/back/myobacklegs_v2.0.xml',
            'target_jnt_range': {'LB_wrapjnt_t1':(0, 0),'LB_wrapjnt_t2':(0, 0),'LB_wrapjnt_r3':(0, 0),
                                 'Abs_t1':(0, 0),'Abs_t2':(0,0),'Abs_r3':(0, 0),
...
fb_model = '/../../../simhive/myo_sim/body/myobody.xml'
...
register_env_with_variants(id='myofullbodyWalk-v0',
        ...
        kwargs={
            ...
            'normalize_act': True,
            'min_height':0.75,    # minimum center of mass height before reset
            'max_rot':0.35,       # maximum rotation before reset
            'reset_type':'init', # none, init, random
            'target_x_vel':0.0,  # desired x velocity in m/s
            'target_y_vel':1.8,  # desired y velocity in m/s
            'target_rot': None   # if None then the initial root pos will be taken, otherwise provide quat
        }
    )
